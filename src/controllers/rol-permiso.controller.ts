...
export class RolPermisoController {
  ...
  async find(
    ...
    return this.rolRepository.tienepermisos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.rolRepository.tienepermisos(id).create(permiso);
  }
  ...
  async patch(
    ...
    return this.rolRepository.tienepermisos(id).patch(permiso, where);
  }
  ...
  async delete(
    ...
    return this.rolRepository.tienepermisos(id).delete(where);
  }
}
